...
- [$\mu_1=\mu_2$, con un $p$-value pari a `r pe$p.value %>% round(4)`]{.correct}
- [$\mu_1\neq \mu_2$, con un $p$-value pari a `r pd$p.value %>% round(4)`]{data-explanation="I due campioni hanno la stessa varianza"}
...
Usare il riquadro sottostante per risolvere l'esercizio precedente (oltre alla [tabella dei quantili](#tabella-dei-quantili)):
