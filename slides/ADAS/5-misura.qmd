...
{{< qrcode https//pbosetti.github.io/teaching_site/slides/ADAS/5-misura.html width=500 height=500 >}}
...
l'**incertezza standard** può essere valutata

- mediante metodi statistici, come alla pagina precedente: in questo caso si parla di incertezza standard di **tipo A**
- mediante l’uso di tutte le informazioni rilevanti possibili: incertezza standard di **tipo B**; essa è preferibile quando non si disponga di campione sufficiente di misure

Per **informazioni rilevanti** si intende ad esempio:
...
$$
nota come **legge di propagazione delle incertezze** a partire dalle incertezze delle componenti (di **tipo A** o di **tipo B**)
...
Entrambe le incertezze sono calcolate da un campione di 20 elementi, entrambi con deviazione standard 2.24 mm: $u=s/\sqrt{n} = 2.24/\sqrt{20} = `r round(2.24/sqrt(20), 2)`~\mathrm{mm}$
