...
::: callout-note
Ricordare che tutte le tabelle presenti in <https://pbosetti.github.io/teaching_site/data.html> possono essere caricate direttamente dalle funzioni `read_table()` o `read_csv()` passando l'URL generato come `adas.utils::examples_url("nome_del_file.csv")`. 
:::
