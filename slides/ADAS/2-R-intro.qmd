...
{{< qrcode https//pbosetti.github.io/teaching_site/slides/ADAS/2-R-intro.html width=500 height=500 >}}
...
## Ambiente Positron
* Installazione: [prima R](https://cran.mirror.garr.it/CRAN/), [poi Positron](https://positron.posit.co)
* **Solo su windows**, installare anche [Rtools](https://cran.mirror.garr.it/CRAN/bin/windows/Rtools/)
* Positron lavora su progetti, o **cartelle**
* Un progetto contiene anche impostazioni specifiche e comuni ai file nella cartella
* Una **sessione** di Positron può operare su un unico progetto
* Si possono aprire più sessioni contemporaneamente
* Positron è un ambiente molto potente e complesso, adatto anche alla compilazione di *report* tecnici, articoli, libri e presentazioni (come questa), e può gestire anche linguaggi diversi da R (come Python, C, C++, ecc.)
...
* Positron è una IDE Open Source per R, basata su Visual Studio Code
* Positron è l'alternativa moderna a **RStudio**
...
## Tidyverse
Assieme a Positron (e RStudio) è emersa una *new wave* di librerie R che modificano radicalmente l'approccio. Vanno sotto il nome collettivo di [`tidyverse`](https://www.tidyverse.org)
...
* L'help in linea per unafunzione può essere ottenuto con il comando `?<nome funzione>`, ad esempio `?summary` (senza parentesi)
* Alcune funzioni però, come `summary()`, sono **funzioni generiche**, e il loro help è scarno
