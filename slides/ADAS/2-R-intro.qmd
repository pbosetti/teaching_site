...
## Ambiente RStudio
* Installazione: [prima R](http://www.r-project.org), [poi RStudio](https://posit.co/downloads/)
...
È utile consultare i cheat sheet: [https://posit.co/resources/cheatsheets/](https://posit.co/resources/cheatsheets/)
