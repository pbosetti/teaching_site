...
subtitle: "Progetto del corso Analisi Dati e Statistica, A.A. 2025--26"
...
format: 
  revealjs:
    ...
    footer: "paolo.bosetti@unitn.it --- [https://pbosetti.github.io/teaching_site/ADAS](https://pbosetti.github.io/teaching_site/ADAS)"
---
...
df %>% ggplot(aes(x=deltaF, group=F)) +
  geom_point(aes(y=angle_r)) +
  geom_line(aes(y=angle_n, color="nominale")) +
  geom_line(aes(y=atan(pred_r)/pi*180, color="regressione"), linetype=2) +
  coord_cartesian(ylim=c(0,10)) +
  labs(color="linea:", y=TeX("$\\delta$ ($^\\circ$)"), x=TeX("$\\Delta F$ (g)")) +
  theme(legend.position = c(0.2, 0.8))
```
...
Per il report usare il template `report.Rmd` sulla  [repository GitHub del corso](https://github.com/pbosetti/ADAS-24) (cliccare [qui per scaricare direttamente il file](https://raw.githubusercontent.com/pbosetti/ADAS-24/main/report.Rmd))
