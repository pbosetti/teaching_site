...
## Modalità d'esame
**ATTENZIONE**: questo corso è il primo di due moduli: l'esame è quindi solo una prova parziale e **non viene verbalizzato**

Il voto finale verrà verbalizzato **solo dopo aver superato** anche la prova parziale del secondo modulo (prof. De Cecco).
...
* **Codice sviluppato in classe**: Il codice R sarà gradualmente pubblicato e aggiornato su GitHub: [https://github.com/pbosetti/ADAS-23](https://github.com/pbosetti/ADAS-23){target="_blank"}