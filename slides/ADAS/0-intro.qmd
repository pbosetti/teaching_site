...
1. [Technical and Analytical Skills]{.bblue}
...
2. [Systems and Process Competence]{.bblue}
...
3. [Digital and Technological Competence]{.bblue}
  ...
  - **Data-driven Methods** → **machine learning**, IoT, digital twins for smart manufacturing.
  - Automation & Control → PLCs, SCADA, robotics basics.

## ✨ ChatGPT: Su quali competenze si basa l'Ing. Ind.?

4. [Managerial and Soft Skills]{.bblue}
...
* Useremo un ambiente (Positron/Quarto) che consente di preparare report e documenti integrando testo, dati e algoritmi
...
È offerta la possibilità di sostenere la prova in itinere che, con le stesse modalità dell'esame finale, copre solo la prima metà del corso

Chi supera e accetta la prova in itinere può sostenere solo metà dell'esame finale, cioè rispondendo solo alle domande relative alla seconda metà del corso

In questo caso il voto finale sarà la media dei due voti, arrotondata all'intero più vicino
...
* **Moodle**
* **Testo di riferimento**: online, su <https://pbosetti.github.io/teaching_site/slides/ADAS>
* **Codice sviluppato in classe**: Il codice R sarà gradualmente pubblicato e aggiornato su GitHub: [https://github.com/pbosetti/ADAS-26](https://github.com/pbosetti/ADAS-26){target="_blank"}
