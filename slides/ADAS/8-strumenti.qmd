...
digraph "catena" {
  ...
  misurando -> trasduttore
  trasduttore -> condizionatore
  condizionatore -> "conversione AD"
  "conversione AD" -> acquisizione
}
```
:::
:::
...
![](https://ars.els-cdn.com/content/image/3-s2.0-B9780128146415500032-u18-05-9780128146415.jpg){width=400}
![Encoder lineare relativo](https://cdn.phidgets.com/docs/images/thumb/e/ef/QuadratureDirection.jpg/300px-QuadratureDirection.jpg)
:::
:::
...
:::column
![Encoder assoluto (rotativo)](https://www.linearmotiontips.com/wp-content/uploads/2021/01/US-Digital-Absolute-Encoder-Disk.jpg)
:::
:::
...
:::column
![Ponte di Wheatstone](https://www.allaboutcircuits.com/uploads/articles/wheatstone_bridge_for_calculator.jpg)
:::
:::
