...
1. [Intro to Statistics](desaned/1-statistics.html){target="_blank"}
2. [Intro to R language](desaned/2-R-intro.html){target="_blank"}
3. [Regression](desaned/3-regression.html){target="_blank"}
4. [K-fold cross validation](desaned/4-kfold.html){target="_blank"}
5. [DoE](desaned/5-DoE.html){target="_blank"}
